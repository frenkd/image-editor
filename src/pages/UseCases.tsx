...
const USE_CASES: UseCase[] = [
  {
    ...
    after: "/use-cases/person-after.jpg",
  ...
  },
  {
    ...
    after: "/use-cases/logo-after.jpg",
    ...
    body: "Remove the background first, then use Color to fill opaque pixels. Handy for marks scanned or photographed on paper.",
  },
];
